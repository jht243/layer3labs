...
const About: NextPage<PageProps> = ({ loaded }) => {
  return (
      <Layout>
        <div className={cx(styles['about-page'], { [styles[`is-loaded`]]: loaded, })}>
          about Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi eos harum provident quibusdam
