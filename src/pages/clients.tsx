    ...
    [
      {
        ...
        description:
          'AI-ENABLED CERTIFICATION AND MEMBER EXPERIENCE PLATFORM FOR LEAGUE BOWLER PROGRAMS',
      },
      {
        image: styrLogo.src,
        description:
          'AI-ASSISTED SNEAKER MARKETPLACE WITH PRICING INTELLIGENCE AND FRAUD PROTECTION',
      },
    ],
    [
      {
        image: GSLogo.src,
        description:
          'AI-POWERED LEAD GENERATION PLATFORM WITH GAMIFIED ENGAGEMENT AND PERSONALIZATION',
      },
      {
        image: JGILogo.src,
        description:
          'MEMBERSHIP, CHARITY, AND DIGITAL TICKETING PLATFORM FOR NATIONAL SPORTS ORGANIZATIONS',
      },
    ],
    [
      {
        ...
        description:
          'AI STRATEGY AND IMPLEMENTATION TO PRESERVE DR. GOODALLS LEGACY AND RESEARCH',
      },
      {
        image: pipeflareLogo.src,
        description:
          'AI-ENHANCED GAMING PLATFORM SUPPORTING 60,000 DAILY PLAYERS AND 7 CUSTOM GAMES',
      },
    ],
  ]
